...
export class AppListComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.chrome = this.constants.i18n.chrome;
    ...
    navigationRoute(url: string, moduleName: string): void {
        ...
        if (moduleName === 'reconcile') {
            window.location.href = url.replace("{co_id}", companyId);
        } else {
        ...
        // }
        // else if (url.indexOf('reprintcheck') > -1) {
        //     this.router.navigate(['company/1/reprintcheck/management']);
        // }
        // else {
        //     window.open(this.getLiveUrl(url, moduleName), "_blank");
        // }
    ...
    loadApps() {
        ...
        this.subscription = this.siteService.getAppsList()
